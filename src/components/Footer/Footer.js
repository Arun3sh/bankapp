    ...
    <footer className="container-sm footer-wrapper">
      <div className="footer-wrapper-content">
        ...
        <div className="footer-solution">
          ...
          <HashLink to="/#smart-watch">Smart Watch</HashLink>
          <HashLink to="/#UPI">UPI</HashLink>
          <HashLink to="/#custom-loan">Loan As per Need</HashLink>
          <HashLink to="/#gold-pledge">Gold Loan</HashLink>
        </div>
        ...
        <div className="footer-company">
          ...
          <p className="address">BankApp Home Office, Coimbatore, India</p>
